...
no vote, and no second person to appeal a decision to — [`.github/CODEOWNERS`](https://github.com/ivylikethevine/sharerr-rs/blob/main/.github/CODEOWNERS)
...
| ----------- | ------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Maintainer  | `@ivylikethevine`, per [`.github/CODEOWNERS`](https://github.com/ivylikethevine/sharerr-rs/blob/main/.github/CODEOWNERS) | Reviews and merges PRs, cuts releases, holds repo admin access, sets the project's direction in [the README's roadmap](../README.md#roadmap), triages security reports.                         |
...
All access (GitHub repository admin, pushing the `v*` tags that release
unattended through the `release` environment, the GHCR packages) sits with
the one maintainer account. The honest
