...
| [Support](SUPPORT.md) | What sharerr talks to today and the seam each category plugs into, and what was tried or considered and deliberately left out — with the reason attached. |
