...
//!
//! Tests for this translation live in `tests/adapter.rs`, alongside the
//! trait-behavior tests for the rest of the crate — nothing here is private
//! to this module, so there is no reason to keep a second, in-crate test
//! harness driving the same mocked-server-plus-trait-call pattern.
